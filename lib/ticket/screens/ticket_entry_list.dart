...
class _TicketEntryListPageState extends State<TicketEntryListPage> {
  ...
  Future<List<TicketEntry>> fetchTicket(CookieRequest request) async {
    final response = await request.get('https://laudya-michelle-sporticket.pbp.cs.ui.ac.id/ticket/json/${widget.matchId}/');
                        ...
                        return TicketEntryCard(
                          ...
                          onDelete: () async {
                            final response = await http.post(
                              Uri.parse("https://laudya-michelle-sporticket.pbp.cs.ui.ac.id/ticket/delete-flutter/${ticket.id}/"),
                            );
